...
**Phase 1 + Mobile UI** are complete and stable (all known data/UI bugs resolved). See `ROADMAP.MD` for what is in scope.
...
*CLAUDE.md version: 1.2 | Project: f1-points-engine | Season: F1 2026*
